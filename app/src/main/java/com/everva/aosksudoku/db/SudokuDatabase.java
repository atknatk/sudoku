...
package com.everva.aosksudoku.db;
...
import com.everva.aosksudoku.gui.SudokuListFilter;
...
/**
 * Wrapper around aosksudoku's database.
 * <p/>
...
public class SudokuDatabase {
	public static final String DATABASE_NAME = "aosksudoku";
