package com.everva.aosksudoku.gui;
...
import com.everva.aosksudoku.db.SudokuDatabase;
import com.everva.aosksudoku.game.FolderInfo;
import com.everva.aosksudoku.gui.exporting.FileExportTask;
import com.everva.aosksudoku.gui.exporting.FileExportTaskParams;
import com.everva.aosksudoku.gui.exporting.FileExportTaskResult;
import com.everva.aosksudoku.gui.exporting.FileExportTask.OnExportFinishedListener;
...
//			mExportParams.sudokuID = intent.getLongExtra(EXTRA_SUDOKU_ID, 0);
	...
	private void exportToFile() {
		...
		File file = new File(directory, filename + ".aosksudoku");
		if (file.exists()) {
	...
	private void startExportToFileTask() {
		...
		mExportParams.file = new File(directory, filename + ".aosksudoku");
