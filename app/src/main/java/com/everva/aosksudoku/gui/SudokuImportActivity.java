...
import com.everva.aosksudoku.gui.importing.AbstractImportTask;
import com.everva.aosksudoku.gui.importing.ExtrasImportTask;
import com.everva.aosksudoku.gui.importing.OpenSudokuImportTask;
import com.everva.aosksudoku.gui.importing.SdmImportTask;
import com.everva.aosksudoku.gui.importing.AbstractImportTask.OnImportFinishedListener;
import com.everva.aosksudoku.utils.Const;

/**
 * This activity is responsible for importing puzzles from various sources
 * (web, file, .aosksudoku, .sdm, extras).
 *
 * @author romario
 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (dataUri != null) {
			if (Const.MIME_TYPE_OPENSUDOKU.equals(intent.getType())
					|| dataUri.toString().endsWith(".aosksudoku")) {
